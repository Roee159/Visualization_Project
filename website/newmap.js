...
// Load the athlete events data and world geometry data
d3.queue()
    .defer(d3.csv, 'athlete_events.csv')
    .defer(d3.json, "https://cdn.jsdelivr.net/npm/world-atlas@2/countries-110m.json")
    .await(function(error, athleteEventData, worldGeometryData) {
        ...
        // Process world geometry data
        var geojsonData = topojson.feature(worldGeometryData, worldGeometryData.objects.countries);
